...
export default function Cards(props){
    ...
    return(
        <div>
            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-0 md:gap-4">
                {/* Aqui va el map */}
                {
                    datos.map((e, index) => (
                        <div key={index} className="cursor-pointer hover:bg-neutral-900 mx-0 md:mx-8 h-fit mt-8 p-4 rounded-xl">
                            ...
                            <div className="flex justify-between mt-4">
                                ...
                                <p className="text-xs md:text-md px-2 py-1 rounded-md bg-green-800">{e.price}</p>
                            </div>
